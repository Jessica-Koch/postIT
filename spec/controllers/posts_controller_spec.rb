...
RSpec.describe PostsController, type: :controller do
    ...
    context "guest user" do
        ...
        describe 'POST create' do
            it "returns http redirect" do
                post :create, params: {topic_id: my_topic.id, post: {title: Faker::Hipster.sentence(2), body: Faker::Hipster.paragraph(1)}}
                expect(response).to redirect_to(new_session_path)
            end
        end
    ...
    context "member user doing CRUD on a post they don't own" do
        ...
        describe "POST create" do
            it "increases the number of Post by 1" do
                expect{post :create, params: {topic_id: my_topic.id, post: {title: Faker::Hipster.sentence(3), body: Faker::Hipster.paragraph(1)}}, as: :json}.to change(Post,:count).by(1)
            end

            it "assigns the new post to @post" do
                post :create, params: {topic_id: my_topic.id, post: {title: Faker::Hipster.sentence(3), body: Faker::Hipster.paragraph(1)}}
